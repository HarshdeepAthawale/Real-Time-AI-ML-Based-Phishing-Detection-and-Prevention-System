"""
Train AI-generated content detector
Similar to train_phishing_model.py but specialized for AI detection
"""
import os
import sys
import json
...
def train_model(
    ...
    # Set labels (1 = AI-generated, 0 = human-written)
...
def main():
    parser = argparse.ArgumentParser(description='Train AI-generated content detector')
    ...
    local_output = f"/tmp/ai_detector_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
    ...
    try:
        ...
        s3_model_prefix = f"{output_prefix}models/nlp/ai_detector/{model_version}/"
